...
// function checkException(targetNum) {
//   if (
//     !targetNum.includes("3") &&
//     !targetNum.includes("6") &&
//     !targetNum.includes("9")
//   ) {
//     return true;
//   }
...
//     const targetNum = i.toString();

//     if (checkException(targetNum)) {
//       continue;
//     }

//     snapSum += check369(targetNum.split(""));
//   }
