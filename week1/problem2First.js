...
console.log(problem2("abacccabba")); // ab
console.log(problem2("abaccckabbb")); // abaka
console.log(problem2("abbbccc")); // a
console.log(problem2("abacㅁㄴㅇㄹㄷba")); // 제한 사항 불만족
console.log(problem2("알파벳이 아니지롱")); // 제한 사항 불만족
console.log(problem2("AINGEONWND")); // 제한 사항 불만족
console.log(problem2("abcdef")); // 아무 것도 안 지워지는 애들
